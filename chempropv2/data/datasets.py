...
from chempropv2.featurizers import MolGraph, MoleculeFeaturizerBase, MoleculeFeaturizer
from chempropv2.data.datapoints import MoleculeDatapoint, ReactionDatapoint
from chempropv2.featurizers.reaction import ReactionFeaturizer, ReactionFeaturizerBase
...
class MolGraphDatasetBase(Dataset):
    ...
    def normalize_targets(self, scaler: Optional[StandardScaler] = None) -> StandardScaler:
        ...
        scaler = (scaler or StandardScaler(with_std=True)).fit(targets)
